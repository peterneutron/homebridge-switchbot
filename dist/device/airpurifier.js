...
export class AirPurifier extends deviceBase {
    ...
    constructor(platform, accessory, device) {
        ...
        this.AirQualitySensor = {
            ...
            Service: accessory.getService(this.hap.Service.AirQualitySensor) ?? accessory.addService(this.hap.Service.AirQualitySensor),
        ...
        accessory.context.AirQualitySensor = this.AirQualitySensor;
