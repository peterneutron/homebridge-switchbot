...
export class Presence extends deviceBase {
    ...
    constructor(platform, accessory, device) {
        ...
        this.OccupancySensor = {
            ...
            Service: accessory.getService(this.hap.Service.OccupancySensor) ?? accessory.addService(this.hap.Service.OccupancySensor),
            OccupancyDetected: accessory.context.OccupancyDetected ?? false,
        };
        accessory.context.OccupancySensor = this.OccupancySensor;
