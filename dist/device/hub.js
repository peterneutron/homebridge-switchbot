...
export class Hub extends deviceBase {
    ...
    constructor(platform, accessory, device) {
        ...
        if (device.hide_lightsensor) {
            ...
            this.LightSensor = {
                ...
                Service: accessory.getService(this.hap.Service.LightSensor) ?? this.accessory.addService(this.hap.Service.LightSensor),
    ...
    async openAPIparseStatus() {
        ...
        const sensorData = this.deviceStatus.sensorData ?? this.deviceStatus;
    ...
    async parseStatusWebhook() {
        ...
        this.debugLog(`(scale, temperature, humidity, lightLevel) = Webhook:(${this.webhookContext.scale}, ${convertUnits(this.webhookContext.temperature, this.webhookContext.scale, this.device.convertUnitTo)}, ${this.webhookContext.humidity}, ${this.webhookContext.lightLevel}), current:(${this.TemperatureSensor?.CurrentTemperature}, ${this.HumiditySensor?.CurrentRelativeHumidity}, ${this.LightSensor?.CurrentAmbientLightLevel})`);
