...
export class Humidifier extends deviceBase {
    ...
    constructor(platform, accessory, device) {
        ...
        // Set category
        accessory.category = 22 /* this.hap.Categories.AIR_HUMIDIFIER */;
        ...
        this.HumidifierDehumidifier = {
            ...
            Service: accessory.getService(this.hap.Service.HumidifierDehumidifier) ?? accessory.addService(this.hap.Service.HumidifierDehumidifier),
        ...
        accessory.context.HumidifierDehumidifier = this.HumidifierDehumidifier;
    ...
    async parseStatusWebhook() {
        ...
        this.debugLog(`(temperature, humidity) = Webhook:(${convertUnits(this.webhookContext.temperature, this.webhookContext.scale, this.device.convertUnitTo)}, ${this.webhookContext.humidity}), current:(${this.TemperatureSensor?.CurrentTemperature}, ${this.HumidifierDehumidifier.CurrentRelativeHumidity})`);
            ...
            try {
                ...
                if (switchBotBLE !== false) {
                    switchBotBLE
                        ...
                        return await device_list[0].percentage(Number(this.HumidifierDehumidifier.RelativeHumidityHumidifierThreshold));
                    })
                        .then(async () => {
