...
export class Contact extends deviceBase {
    ...
    constructor(platform, accessory, device) {
        ...
        this.ContactSensor = {
            ...
            Service: accessory.getService(this.hap.Service.ContactSensor) ?? accessory.addService(this.hap.Service.ContactSensor),
            ContactSensorState: accessory.context.ContactSensorState ?? this.hap.Characteristic.ContactSensorState.CONTACT_DETECTED,
        };
        accessory.context.ContactSensor = this.ContactSensor;
        ...
        if (this.device.hide_motionsensor) {
            ...
            this.MotionSensor = {
                ...
                Service: accessory.getService(this.hap.Service.MotionSensor) ?? accessory.addService(this.hap.Service.MotionSensor),
                MotionDetected: accessory.context.MotionDetected ?? false,
            };
            accessory.context.MotionSensor = this.MotionSensor;
    ...
    async BLEparseStatus() {
        ...
        // MotionDetected
        if (!this.device.hide_motionsensor && this.MotionSensor?.Service) {
    ...
    getContactSensorState(openState) {
