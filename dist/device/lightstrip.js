            ...
            try {
                ...
                if (switchBotBLE !== false) {
                    switchBotBLE
                        ...
                        return await device_list[0].setBrightness(Number(this.LightBulb.Brightness));
                    })
                        .then(async () => {
            ...
            try {
                ...
                if (switchBotBLE !== false) {
                    switchBotBLE
                        ...
                        return await device_list[0].setRGB(Number(this.LightBulb.Brightness), red, green, blue);
                    })
                        .then(async () => {
